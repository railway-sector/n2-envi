import{I4 as be,I0 as we,Il as De,Ga as f,Hk as w,I9 as Ve,Gb as H,G7 as r,bX as z,xs as ee,I3 as xe,G_ as E,d1 as te,c$ as A,hq as G,Im as Le,hS as ie,Hi as ne,GE as S,gi as _,c_ as v,In as se,zy as ae,v as o,m3 as re,hp as ye,rM as Ee,d2 as Se,dd as le,fu as oe,hn as Ce,I1 as Me,xG as Ae,GC as $e,Hs as Re,G6 as B,c7 as Te,qL as ce,qN as he,_ as de,gk as Ie,b_ as F,qe as q,$ as c,a2 as j,jD as pe,gl as ue,cY as Oe,d0 as O,lf as Ue,GP as qe,lh as ze,Io as je,Gm as V,o9 as Ne,oa as k,Ip as We,m1 as He,Iq as $,Ir as Ge,ww as X,rI as Be,vg as Fe,rJ as ke,rK as Xe,rL as Je,rN as Ke,a1 as C,Is as Qe,c0 as J}from"./index-BOnqy64d.js";import{t as Ye}from"./VisualElement-Ds9_URfF.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new H("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>_(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>_(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new E("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(D,l),te(D,D,u),A(d,D),d[3]=G(D),d)),new Le("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,ie(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/G(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
