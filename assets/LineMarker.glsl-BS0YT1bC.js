import{xs as te,Hq as ie,Hr as re,G3 as ae,Hs as se,Ht as oe,G7 as o,Hj as ne,GC as ce,Hi as le,G6 as y,Hu as pe,Hv as de,GG as N,G5 as he,G8 as ve,G9 as ue,G_ as me,Gb as fe,Hw as R,Hx as E,Hy as ge,Hz as Se,GH as Pe,gl as ye,qL as _e,jD as we,qN as xe,_ as ze,qP as W,Gd as U,Ge as $e,Gf as q,qQ as L,Gh as be,Gi as ke,Gk as Ve,HA as Oe,HB as I,HC as B,HD as Te,HE as Ce,HF as De,$ as d,a2 as We,GJ as Me,Gm as m,fX as Le,Go as M,GM as je,HG as Q,t0 as He,Ha as Ge,HH as Ae,Gp as Fe,d0 as Y,ks as Ne,gi as J,v as X,HI as Re}from"./index-BAPKyJFb.js";function K(r){const e=new te,{space:a,anchor:t,hasTip:_,hasScreenSizePerspective:w}=r,f=a===2,k=a===1;e.attributes.add("position","vec3"),e.vertex.inputs.add("position",()=>"position"),e.include(ie,r),e.include(re,r);const{vertex:i,fragment:S,varyings:g}=e;ae(i,r),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),g.add("vColor","vec4"),g.add("vpos","vec3",{invariant:!0}),g.add("vUV","vec2"),g.add("vSize","float"),_&&g.add("vLineWidth","float"),i.uniforms.add(new se("nearFar",({camera:c})=>c.nearFar),new oe("viewport",({camera:c})=>c.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
return clamp(0.5 - pixelDistance, 0.0, 1.0);
  ...
  `)),e.include(Pe,r),e.include(E),S.main.add(o`
    ...
    outputColorHighlightOLID(applySlice(finalColor, vpos), finalColor.rgb);`),e}const Ee=Object.freeze(Object.defineProperty({__proto__:null,build:K},Symbol.toStringTag,{value:"Module"}));let j=class extends _e{constructor(e,a){super(e,a,we(Z(a))),this.shader=new xe(Ee,()=>ze(()=>Promise.resolve().then(()=>Ye),void 0))}_makePipelineState(e,a){const{output:t,space:_,hasOccludees:w}=e;return W({blending:Ve(t,!1,e.emissionDimmingPass),depthTest:_===0?null:ke(t),depthWrite:be(e),colorWrite:L,stencilWrite:w?q:null,stencilTest:w?a?U:$e:null,polygonOffset:{factor:0,units:-10}})}initializePipeline(e){return e.occluder?(this._occluderPipelineTransparent=W({blending:B,depthTest:I,depthWrite:null,colorWrite:L,stencilWrite:null,stencilTest:Oe}),this._occluderPipelineOpaque=W({blending:B,depthTest:I,depthWrite:null,colorWrite:L,stencilWrite:Ce,stencilTest:Te}),this._occluderPipelineMaskWrite=W({blending:null,depthTest:De,depthWrite:null,colorWrite:null,stencilWrite:q,stencilTest:U})):this._occluderPipelineTransparent=this._occluderPipelineOpaque=this._occluderPipelineMaskWrite=null,this._occludeePipelineState=this._makePipelineState(e,!0),this._makePipelineState(e,!1)}getPipeline(e,a,t){return t?this._occludeePipelineState:e.occluder===11?this._occluderPipelineTransparent??super.getPipeline(e,a,t):e.occluder===10?this._occluderPipelineOpaque??super.getPipeline(e,a,t):this._occluderPipelineMaskWrite??super.getPipeline(e,a,t)}};function Z(r){const e=ye().vec3f("position").vec4f16("previousDelta").vec2f16("uv0");return r.hasVVColor?e.f32("colorFeatureAttribute"):e.vec4u8("color",{glNormalized:!0}),r.hasVVOpacity&&e.f32("opacityFeatureAttribute"),r.hasVVSize?e.f32("sizeFeatureAttribute"):e.f16("size"),r.worldSpace&&e.vec3f16("normal"),e.freeze()}j=d([We("esri.views.3d.webgl-engine.shaders.LineMarkerTechnique")],j);class h extends Me{constructor(e){super(),this.spherical=e,this.space=1,this.anchor=0,this.occluder=!1,this.writeDepth=!1,this.hideOnShortSegments=!1,this.hasCap=!1,this.hasTip=!1,this.hasVVSize=!1,this.hasVVColor=!1,this.hasVVOpacity=!1,this.hasOccludees=!1,this.hasScreenSizePerspective=!1,this.textureCoordinateType=0,this.emissionSource=0,this.discardInvisibleFragments=!0,this.occlusionPass=!1,this.hasVVInstancing=!1,this.hasSliceTranslatedView=!0,this.olidColorInstanced=!1,this.overlayEnabled=!1,this.snowCover=!1}get draped(){return this.space===0}get worldSpace(){return this.space===2}}d([m({count:3})],h.prototype,"space",void 0),d([m({count:2})],h.prototype,"anchor",void 0),d([m()],h.prototype,"occluder",void 0),d([m()],h.prototype,"writeDepth",void 0),d([m()],h.prototype,"hideOnShortSegments",void 0),d([m()],h.prototype,"hasCap",void 0),d([m()],h.prototype,"hasTip",void 0),d([m()],h.prototype,"hasVVSize",void 0),d([m()],h.prototype,"hasVVColor",void 0),d([m()],h.prototype,"hasVVOpacity",void 0),d([m()],h.prototype,"hasOccludees",void 0),d([m()],h.prototype,"hasScreenSizePerspective",void 0);class Ke extends Le{constructor(e,a){super(e,qe),this.produces=new Map([[2,t=>t===10||M(t)&&this.parameters.renderOccluded===8],[3,t=>je(t)],[10,t=>Q(t)&&this.parameters.renderOccluded===8],[11,t=>Q(t)&&this.parameters.renderOccluded===8],[4,t=>M(t)&&this.parameters.writeDepth],[8,t=>M(t)&&!this.parameters.writeDepth],[18,t=>M(t)||t===10]]),this.intersectDraped=void 0,this._configuration=new h(a)}updateConfiguration(e){super.updateConfiguration(e),this._configuration.space=e.slot===18?0:this.parameters.worldSpace?2:1,this._configuration.hideOnShortSegments=this.parameters.hideOnShortSegments,this._configuration.hasCap=this.parameters.cap!==0,this._configuration.anchor=this.parameters.anchor,this._configuration.hasTip=this.parameters.hasTip,this._configuration.hasSlicePlane=this.parameters.hasSlicePlane,this._configuration.hasOccludees=e.hasOccludees,this._configuration.writeDepth=this.parameters.writeDepth,this._configuration.hasVVSize=this.parameters.hasVVSize,this._configuration.hasVVColor=this.parameters.hasVVColor,this._configuration.hasVVOpacity=this.parameters.hasVVOpacity,this._configuration.occluder=this.parameters.renderOccluded===8,this._configuration.hasScreenSizePerspective=this.parameters.screenSizePerspective!=null}get visible(){return this.parameters.color[3]>=He}intersect(){}createBufferWriter(){return new Ie(Z(this.parameters),this.parameters)}createGLMaterial(e){return new Ue(e)}}class Ue extends Fe{dispose(){super.dispose(),this._markerTextures?.release(this._markerPrimitive),this._markerPrimitive=null}beginSlot(e){const a=this._material.parameters.markerPrimitive;return a!==this._markerPrimitive&&(this._material.setParameters({markerTexture:this._markerTextures.swap(a,this._markerPrimitive)}),this._markerPrimitive=a),this.getTechnique(j,e)}}class qe extends Ge{constructor(){super(...arguments),this.width=0,this.color=[1,1,1,1],this.markerPrimitive="arrow",this.placement="end",this.cap=0,this.anchor=0,this.hasTip=!1,this.worldSpace=!1,this.hideOnShortSegments=!1,this.writeDepth=!0,this.hasSlicePlane=!1,this.vvFastUpdate=!1,this.stipplePattern=null,this.markerTexture=null}}class Ie{constructor(e,a){this.layout=e,this._parameters=a}elementCount(){return this._parameters.placement==="begin-end"?12:6}write(e,a,t,_,w){if(w==null)return;const{buffer:f,offset:k}=w,i=t.get("position").data,S=i.length/3;let g=[1,0,0];const l=t.get("normal");this._parameters.worldSpace&&l!=null&&(g=l.data);let c=1,H=0;this._parameters.vvSize?H=t.get("sizeFeatureAttribute").data[0]:t.has("size")&&(c=t.get("size").data[0]);let z=[1,1,1,1],G=0;this._parameters.vvColor?G=t.get("colorFeatureAttribute").data[0]:t.has("color")&&(z=t.get("color").data);let A=0;this._parameters.vvOpacity&&(A=t.get("opacityFeatureAttribute").data[0]);const x=new Float32Array(f.buffer),P=Ae(f.buffer),V=new Uint8Array(f.buffer);let p=k*(this.layout.stride/4);const $=x.BYTES_PER_ELEMENT/P.BYTES_PER_ELEMENT,ee=4/$,b=(n,T,v,u)=>{x[p++]=n[0],x[p++]=n[1],x[p++]=n[2],Re(T,n,P,p*$),p+=ee;let s=p*$;if(P[s++]=v[0],P[s++]=v[1],p=Math.ceil(s/$),this._parameters.vvColor)x[p++]=G;else{const C=Math.min(4*u,z.length-4),D=4*p++;V[D]=255*z[C],V[D+1]=255*z[C+1],V[D+2]=255*z[C+2],V[D+3]=255*z[C+3]}this._parameters.vvOpacity&&(x[p++]=A),s=p*$,this._parameters.vvSize?(x[p++]=H,s+=2):P[s++]=c,this._parameters.worldSpace&&(P[s++]=g[0],P[s++]=g[1],P[s++]=g[2]),p=Math.ceil(s/$)},F=(n,T)=>{const v=Y(Be,i[3*n],i[3*n+1],i[3*n+2]),u=Qe;let s=n+T;do Y(u,i[3*s],i[3*s+1],i[3*s+2]),s+=T;while(Ne(v,u)&&s>=0&&s<S);e&&(J(v,v,e),J(u,u,e)),b(v,u,[-1,-1],n),b(v,u,[1,-1],n),b(v,u,[1,1],n),b(v,u,[-1,-1],n),b(v,u,[1,1],n),b(v,u,[-1,1],n)},O=this._parameters.placement;O!=="begin"&&O!=="begin-end"||F(0,1),O!=="end"&&O!=="begin-end"||F(S-1,-1)}}const Be=X(),Qe=X(),Ye=Object.freeze(Object.defineProperty({__proto__:null,build:K},Symbol.toStringTag,{value:"Module"}));export{Ke as g};
