import{JW as be,JS as we,Kb as De,I0 as f,Ja as w,J$ as Ve,I1 as F,HZ as r,c2 as j,xR as ee,JV as xe,IQ as E,d8 as te,d6 as A,hA as H,Kc as ye,i0 as ie,J8 as ne,Iu as S,gs as _,d5 as v,Kd as se,Ab as ae,n as o,mA as re,hz as Le,s9 as Ee,d9 as Se,dk as le,fE as oe,hx as Ce,JT as Me,y3 as Ae,Is as $e,Ji as Re,HY as B,ce as Te,r8 as ce,ra as he,_ as de,gu as Ie,c5 as G,qD as z,ak as c,an as q,jM as pe,gv as ue,d3 as Oe,d7 as O,lM as Ue,IF as ze,lO as je,Ke as qe,Ic as V,oz as Ne,oA as J,Kf as We,my as Fe,Kg as $,Kh as He,wV as K,s5 as Be,vF as Ge,s6 as Je,s7 as Ke,s8 as ke,sa as Qe,am as C,Ki as Xe,c7 as k}from"./index-DRsvZISr.js";import{t as Ze}from"./VisualElement-BiWp_jFy.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new F("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
